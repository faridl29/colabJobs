...
class QuestionAnswer extends CI_Controller {
	...
	public function index()
	{
       ...
       $data['data'] = $this->Question_Answer_model->get_question_all($config["per_page"], $data['page']);           
       ...
       $this->load->view('user/questionanswer', $data);
    }
	...
	private function _validate()
	{
       ...
       $data['data'] = $this->Question_Answer_model->get_question_with_filter($config["per_page"], $data['page'], $search);           
